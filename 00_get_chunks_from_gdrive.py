...
os.chdir('/vol/v1/general_files/user_files/ben/LTOP_FTV_py_revised/LTOP_FTV_Py/') #GoogleAuth looks in here for an authorization file - could pass the file as an argument and the get the os.path.dirname
